...
const MAP_URL = "https://www.google.com/maps/place/11%C2%B039'08.3%22N+76%C2%B016'03.7%22E/@11.652306,76.267694,17z"
    ...
    <div className="pt-24 md:pt-32">
        ...
        <div className="container max-w-7xl px-6">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-12">
            <motion.div
              ...
              viewport={{ once: true }}
              whileHover={{ y: -8 }}
              className="livora-aesthetic-card flex flex-col items-center rounded-[26px] border border-gold/10 bg-white/88 px-6 py-8 text-center shadow-[0_18px_50px_rgba(30,26,23,0.05)] backdrop-blur"
            >
      ...
      <section className="relative h-[460px] w-full overflow-hidden bg-slate-100 md:h-[540px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center px-6">
          <div className="livora-aesthetic-card livora-static-card max-w-[320px] rounded-[28px] border border-gold/20 bg-white/90 p-6 text-center shadow-2xl backdrop-blur md:max-w-[360px] md:rounded-2xl md:p-8">
